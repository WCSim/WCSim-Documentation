...
\begin{description}
  ...
  \begin{description}
    ...
    \item \texttt{GetNcherenkovhits()} - number of true chereknov hits
    \item \texttt{GetCherenkovHits()} - true PMT hits in each PMT
    \item \texttt{GetCherenkovHitTimes()} - the true times of all the cherenkov hits 
